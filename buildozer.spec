...
requirements = python3==3.9.10, hostpython3==3.9.10, kivy, https://github.com/kivymd/KivyMD/archive/master.zip, pillow, android, pillow, openssl, pyopenssl, httplib2, certifi, sqlite3
